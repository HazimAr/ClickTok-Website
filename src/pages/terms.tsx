    ...
    <Container>
      <ContainerInside>
        ...
        <p>
          ...
          and ClickTok ("<strong>Company</strong>," &ldquo;<strong>we</strong>,"
          &ldquo;<strong>us</strong>," or &ldquo;<strong>our</strong>&rdquo;),
          concerning your access to and use of the clicktok.xyz website as well
        ...
        <p>
          ...
          will alert you about any changes by updating the &ldquo;Last
        ...
        <p>
          By agreeing to these terms, you also agree to abide by the Terms of
          Service of TikTok, Inc. &amp; Discord, Inc.
        </p>
        <p>__________</p>
        <p>
        ...
        <p>
          <strong>8. THIRD-PARTY WEBSITE AND CONTENT</strong>
        </p>
        <p>
        ...
        <p>
          ...
          Policy:<strong> __________</strong>. By using the Site, you agree to
        ...
        <p>
          ...
          at the AAA website:{" "}
          <a href="http://www.adr.org/" target="_blank" rel="noopener">
          ...
          place in United States, Nevada. Except as otherwise provided herein,
        ...
        <p>
          ...
          and federal courts located in United States, Nevada, and the Parties
        ...
        <p>
          <strong>clicktok.xyz</strong>
        </p>
        <p>
          <strong>__________</strong>
        </p>
        <p>
          <strong>info@clicktok.xyz</strong>
        </p>
      </ContainerInside>
    </Container>
  );
