    ...
    <Container py={10}>
      <ContainerInside>
        <div>
          ...
          <p>
            <strong>
              This privacy notice for ClickTok ("Company," "we," "us," or
          ...
          <ul>
            <li>
              ...
              <a href="https://clicktok.xyz/" target="_blank" rel="noopener">
                <strong>https://clicktok.xyz</strong>
              </a>
              <strong>
          ...
          <p>
            <strong>
              ...
              depending on how you interact with ClickTok and the Services, the
          ...
          <p>
            <strong>
              ...
              here: clicktok.xyz/support, or by contacting us. We will consider
          ...
          <ul>
            <li>
              <strong>Converted TikTok ID</strong>
            </li>
          </ul>
          <ul>
            <li>
              <strong>Date of Conversion</strong>
            </li>
          </ul>
          <p>
            <strong>
          ...
          <ul>
            <li>
              <strong>
                For Analytics. To obtain information about the usage of our
                product
              </strong>
            </li>
          </ul>
          ...
          <ul>
            <li>
              <strong>
                ...
                To do so, please contact us at support@clicktok.xyz
              </strong>
            </li>
          </ul>
          <ul>
          ...
          <p>
            <strong>
              ...
              withdraw your consent at any time. To do so, please contact us at
              support@clicktok.xyz
            </strong>
          </p>
          <p>
            <strong>
          ...
          <p>
            ...
            <a
              href="https://jsonformatter.org/html-viewer#contact"
              target="_blank"
              rel="noopener"
            >
          ...
          <p>
            ...
            <a
              ...
              rel="noopener"
            >
              <strong>https://www.edoeb.admin.ch/edoeb/en/home.html</strong>
            </a>
            <strong>.</strong>
          </p>
          <p>
          ...
          <p>
            ...
            <a
              ...
              rel="noopener"
            >
              <strong>http://www.aboutads.info/choices/</strong>
            </a>
            <strong>.</strong>
          </p>
          <p>
            <strong>
              ...
              may email us at support@clicktok.xyz.
            </strong>
          </p>
          <p>
          ...
          <p>
            <strong>
              ...
              us at support@clicktok.xyz or by post to:
            </strong>
          </p>
          <p>
            <strong>ClickTok</strong>
          </p>
          <p>
